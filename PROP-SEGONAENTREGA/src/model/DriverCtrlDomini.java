        ...
        while (option != 21) {
            switch (option) {
                ...
                case 1:
                    ...
                    any = scan.nextInt();
                    try {
                        c.crearPlaEstudis(nomP, any, null);
                ...
                case 7:
                    ...
                    try {
                        c.crearAssignatura(nomA1, quadrimestre, null, null);
                    } catch (RestriccioIntegritatException e) {
                ...
                case 15:
                    ...
                    t = Aula.stringToTipusAula(taula);
                    try {
                        c.creaAula(edifici, planta, aula, capacitat, t.toString());
                    } catch (RestriccioIntegritatException e) {
                ...
                case 17:
                    ...
                    t = Aula.stringToTipusAula(taula);
                    try {
                        c.modificarAula(Aula.crearkey(edifici, planta, aula), capacitat, t.toString());
                    } catch (NotFoundException e) {
