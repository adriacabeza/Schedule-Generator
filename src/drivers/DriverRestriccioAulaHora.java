...
import model.Aula;
import model.RestriccioAulaHora;

import java.util.Scanner;

public class DriverRestriccioAulaHora {
    ...
    public static RestriccioAulaHora creador (Scanner s){
        Aula aula = creaAula(s);
        System.out.println("indica la hora");
        int hora = s.nextInt();
        System.out.println("Ara escriu el dia de la setmana");
        return new RestriccioAulaHora(fromDia2int(s.next()), hora, aula);
    }
